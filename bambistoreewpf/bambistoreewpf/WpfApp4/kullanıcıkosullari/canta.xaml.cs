...
{
    /// <summary>
    /// Interaction logic for canta.xaml
    /// </summary>
    public partial class canta : Window
    {
        public canta()
        {
            InitializeComponent();
        ...
        private void sepeteeklee_Click(object sender, RoutedEventArgs e)
        {
            ...
            urunusepet.butonrengi.Content = "KURŞUN";
            urunusepet.image0.Source = image444.Source;
            urunusepet.image2.Source = image444.Source;
            BitmapImage bitmapImage = new BitmapImage();
            bitmapImage.BeginInit();
            bitmapImage.UriSource = new Uri(@"images/onizleme/kursun-canta-g3518630009-ebe5.", UriKind.RelativeOrAbsolute);
            bitmapImage.EndInit();
            urunusepet.image1.Source = bitmapImage;
            urunusepet.labe1.Content = "BAMBİ";
            urunusepet.labe2.Content = "KURŞUN KADIN ÇANTA G3518630009";
            urunusepet.labe3.Text = label1.Content.ToString();
            urunusepet.texblock.Text = sepetfiyati1.Text;
            urunusepet.borderbeden.Visibility = Visibility.Hidden;
            urunusepet.bt1.Visibility = Visibility.Hidden;
            urunusepet.bt2.Visibility = Visibility.Hidden;
            urunusepet.bt3.Visibility = Visibility.Hidden;
            urunusepet.bt4.Visibility = Visibility.Hidden;
            urunusepet.bt5.Visibility = Visibility.Hidden;
            urunusepet.bt6.Visibility = Visibility.Hidden;
            if (uyeyeri44.Visibility == Visibility.Visible && uyeyerigrid.Visibility == Visibility.Hidden)
            {
        ...
        private void sepeteeklee2_Click(object sender, RoutedEventArgs e)
        {
            ...
            BitmapImage bitmapImage = new BitmapImage();
            bitmapImage.BeginInit();
            bitmapImage.UriSource = new Uri(@"images/siyah-canta-g3485089309-4857.", UriKind.RelativeOrAbsolute);
            bitmapImage.EndInit();
            urunusepet.image1.Source = bitmapImage;
            urunusepet.labe1.Content = "BAMBİ";
            urunusepet.labe2.Content = "SIYAH KADIN ÇANTA G3485089309";
